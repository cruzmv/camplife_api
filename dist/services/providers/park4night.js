    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const center of regionCenters) {
            ...
            for (const url of regionURLs) {
                try {
                    const park4NightData = yield fetchDataFromPark4Night(url);
...
function generateURLsForRegion(centerLat, centerLng, gridSize, zoom) {
    const urls = [];
    const latRange = 1.0;
    const lngRange = 1.0;
...
function fetchDataFromPark4Night(apiUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        const maxRetries = 3;
        let currentRetry = 0;
...
function park4NightCategory(code) {
    let category = 'Park4Night Category';
    switch (code) {
        case 'P':
            category = 'PARKING LOT DAY/NIGHT';
            break;
        case 'DS':
        ...
        case 'C':
            ...
            break;
        case 'ACC_PR':
            category = 'PRIVATE CAR PARK FOR CAMPERS';
            break;
        case 'ACC_P':
            category = 'PAYING MOTORHOME AREA';
            break;
        case 'F':
            category = 'ON THE FARM';
            break;
        case 'PN':
            category = 'SURROUNDED BY NATURE';
            break;
        case 'PJ':
            category = 'DAILY PARKING LOT ONLY';
            break;
        case 'APN':
        ...
        case 'AR':
            ...
            break;
        case 'EP':
            category = 'HOMESTAYS ACCOMMODATION';
            break;
...
exports.name = name;
//# sourceMappingURL=park4night.js.map