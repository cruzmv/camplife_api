...
exports.feedPark4NightDB = exports.updatePark4NightDB = exports.updateCruiserList = exports.updatePark4NightCoordinates = void 0;
const postgresql_1 = require("./postgresql");
const park4night_1 = require("./providers/park4night");
const rxjs_1 = require("rxjs");
function feedPark4NightDB(campings) {
    return new rxjs_1.Observable((observer) => {
        const flatDataItems = (0, park4night_1.flatData)(campings);
        const processedData = flatDataItems.map((data) => {
        ...
        (0, postgresql_1.updateCampings)(processedData).subscribe(result => {
            observer.next(result);
            observer.complete();
        });
    });
}
exports.feedPark4NightDB = feedPark4NightDB;
...
// });
// }
function updatePark4NightDB(places) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const flatDataItems = (0, park4night_1.flatData)(places);
            const processedData = flatDataItems.map((data) => {
                var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, _24, _25, _26, _27, _28, _29, _30, _31, _32, _33, _34, _35, _36, _37, _38, _39, _40, _41, _42, _43, _44, _45, _46, _47, _48, _49, _50, _51, _52;
                const processed = {
                    id: null,
...
exports.updatePark4NightDB = updatePark4NightDB;
